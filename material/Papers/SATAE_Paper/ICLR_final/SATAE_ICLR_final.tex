...
\begin{subfigure}[b]{0.225\textwidth}
	...
	\begin{subfigure}[b]{0.2\textwidth}
		\centering 
		\includegraphics[width=2.5cm, height=10cm]{.//gabors_full.png}
		\caption{}
	\end{subfigure} 
	\begin{subfigure}[b]{0.2\textwidth}
		\centering 
	...
	\begin{subfigure}[b]{0.225\textwidth}
		\centering 
		\includegraphics[width=2.5cm, height=10cm]{.//CIFAR_shrink01.png}
		\caption{}
	\end{subfigure} 
	\begin{subfigure}[b]{0.225\textwidth}
		\centering 
		\includegraphics[width=2.5cm, height=10cm]{.//CIFAR_shrink05.png}
		\caption{}
	\end{subfigure} 
	\begin{subfigure}[b]{0.2\textwidth}
		\centering 
...
\bibitem{bengio_new} Guillaume Alain and Yoshua Bengio, What Regularized Auto-Encoders Learn from the Data Generating Distribution. arXiv:1211.4246v3 [cs.LG] 
