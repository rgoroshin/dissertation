...
%\begin{figure}
%  \centering
%   \includegraphics[width=0.4\textwidth]{./figures/delta_ambiguity.pdf}
...
\begin{figure}
  \centering
     ...
     \includegraphics[width=1\textwidth]{./figures/pretty_decoder.png} 
     \caption{Shallow Architecture 1}
     \end{subfigure} \hspace{0.25cm}
     \begin{subfigure}{0.25\textwidth} 
      \includegraphics[width=1\textwidth]{./figures/dec200.png} 
